...
namespace PlayList.Data {
    ...
    public partial class SongDataSet : global::System.Data.DataSet {
        ...
        public partial class SongDataTable : global::System.Data.TypedTableBase<SongRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public SongRow AddSongRow(string Title, string Artist, string Album) {
...
namespace PlayList.Data.SongDataSetTableAdapters {
    ...
    public partial class SongTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Song] WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title) A" +
                "ND ([Artist] = @Original_Artist) AND ([Album] = @Original_Album))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Song] ([Title], [Artist], [Album]) VALUES (@Title, @Artist, @Album);" +
                "\r\nSELECT Id, Title, Artist, Album FROM Song WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Song] SET [Title] = @Title, [Artist] = @Artist, [Album] = @Album WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title) AND ([Artist] = @Original_Artist) AND ([Album] = @Original_Album));
SELECT Id, Title, Artist, Album FROM Song WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PlayList.Data.Properties.Settings.Default.PlayListDBConnectionString;
        }
        ...
        public virtual int Fill(SongDataSet.SongDataTable dataTable) {
        ...
        public virtual SongDataSet.SongDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SongDataSet.SongDataTable dataTable = new SongDataSet.SongDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SongDataSet.SongDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Title, string Original_Artist, string Original_Album) {
        ...
        public virtual int Insert(string Title, string Artist, string Album) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Artist, string Album, int Original_Id, string Original_Title, string Original_Artist, string Original_Album, int Id) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
            ...
            if ((Original_Album == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_Album));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Artist, string Album, int Original_Id, string Original_Title, string Original_Artist, string Original_Album) {
            return this.Update(Title, Artist, Album, Original_Id, Original_Title, Original_Artist, Original_Album, Original_Id);
        }
    }
